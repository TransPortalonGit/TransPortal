...
<li class="dropdown {{( preg_match("/^inventory/i", Request::path()) ) ? 'active' : ''}}">
	...
	<ul class="dropdown-menu">
        <li><a href="/projects/create">New project</a></li>
       	<li class="divider"></li>
        <li><a href="/tutorials/create">New tutorial</a></li> 
  	</ul>
</li>
...
<li class="dropdown pull-right {{( preg_match("/^profile/i", Request::path()) ) ? 'active' : ''}}" id="dropdown-menu">
	...
	<ul class="dropdown-menu">
		<li><a href="/profile/show/{{Sentry::getUser()->username}}" title="Profile"><i class="fa  fa-tachometer" style="margin-right: 10px;"></i>Dashboard</a></li>
	...
	<div class="dropdown-menu" style="width: 180px;">
		<form style="margin: 0px" accept-charset="UTF-8" action="/account/login" method="post">
			...
			<fieldset class='textbox' style="padding:10px">
				...
				<input style="margin-top: 8px" type="password" placeholder="Password" name="password"/>
