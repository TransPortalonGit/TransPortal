        ...
        <div class="left-box-contents">
          <div class="left-box-item" id="site-news">
            ...
            <ul style="list-style: none; margin:0; padding:10px; padding-top: 5px; font-size: 12px;">
              ...
              <li><a href="http://dk1.informatik.uni-bremen.de/latestnews/news">Bremen Fablab: Workshop Day </a></li> <hr>
              <li><a href="http://dk1.informatik.uni-bremen.de/latestnews/news">Fablab International Meal</a></li> <hr>
              <li><a href="http://dk1.informatik.uni-bremen.de/latestnews/news">Welcome to the Bremen Fablab</a></li> <hr>
            </ul>
          </div>
