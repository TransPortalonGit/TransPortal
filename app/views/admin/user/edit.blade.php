			...
			<div class="col-xs-3">
				...
				<label class="control-label" for="permissions">Permissions</label>
					<div class="controls">
						...
						<input type="checkbox" name="p_3dprinter" id="p_3dprinter" value="1" checked />3D Printer
						@else
						<input type="checkbox" name="p_3dprinter" id="p_3dprinter" value="1" />3D Printer
						@endif
						<p> </p>
						@if($user->hasAccess('lasercutter'))
						<input type="checkbox" name="p_lasercutter" id="p_lasercutter" value="1" checked />Laser Cutter
						@else
						<input type="checkbox" name="p_lasercutter" id="p_lasercutter" value="1" />Laser Cutter
						@endif
